...
export function buildDurableRecordingMetadata({ metadata, webmFilename, mp4Filename, webmProbe, mp4Probe, webmSha256, mp4Sha256, mp4SizeBytes }) {
  const durable = {
    ...
    pacing_profile: metadata.pacing_profile || metadata.pacing,
    pacing_defaults: metadata.pacing_defaults || null,
    ...
    canonical_output_provenance: metadata.canonical_output_provenance || 'validated_servsync_demo_recorder',
