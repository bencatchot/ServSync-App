...
const BROWSER_CALLABLE_SECURITY_DEFINER_RPCS = [
  ...
  'servsync_get_estimate_actor_audit',
...
const INTERNAL_ONLY_SECURITY_DEFINER_RPCS = [
  ...
  'servsync_private_capture_estimate_actor_audit',
  'servsync_private_capture_estimate_child_edit',
  'servsync_private_append_estimate_sent_activity',
