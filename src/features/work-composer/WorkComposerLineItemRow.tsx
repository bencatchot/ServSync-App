...
export function workComposerLineItemRowAdvancedVisibility(
  ...
  const supportsCatalogDetails = itemLabel !== 'draft job' && itemLabel !== 'draft estimate' && itemLabel !== 'draft';
  return {
...
export function WorkComposerLineItemRow({
  ...
  const isDraftScope = itemLabel === 'draft job' || itemLabel === 'draft estimate' || itemLabel === 'draft';
  ...
  const inputPrefix = itemLabel === 'invoice' ? 'Invoice' : itemLabel === 'estimate' ? 'Estimate' : itemLabel === 'draft job' ? 'Draft job' : itemLabel === 'draft estimate' ? 'Draft estimate' : 'Draft';
