...
- Remaining boundary: Production/Demo migration-first rollout remains the only release gate. Electronic signatures, stronger identity verification, payments/deposits, replies, SMS, decline/negotiation, report acknowledgment, broader guest actions, Service Plans, and complete anonymous Customer portals remain separate product work.
- Backlog impact:
