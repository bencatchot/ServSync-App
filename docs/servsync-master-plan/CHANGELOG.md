...
- Backlog impact:
  ...
  - REASON: FB-035 now references the Draft-First Work principle, contextual `Start New Draft` guidance, naming direction, no-side-effect guardrails, and the need to plan Jobs landing/contextual entries against the principle without claiming those UI changes are shipped.
- Master plan impact:
