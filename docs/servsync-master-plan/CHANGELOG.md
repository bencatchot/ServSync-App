...
- Summary of change: Cleaned up the homeowner Contractors tab hub so the top action area focuses on Find a contractor, My Contractors, and Invite a contractor. Moved the contractor relationship flow above the tiles, removed the top Start a service request tile, strengthened the remaining tile treatment, and kept connected-contractor request actions available inside existing contractor relationship cards.
...
- Known risks or follow-ups:
  - Preview smoke should confirm the three-tile hub treatment feels visually prominent without overpowering the connected-contractor list.
