...
Last reconciled against `origin/main` at `4a5962e79f3002713d904d1710466f1db79740bc` (merged PR #364).
...
| FB-002 | Contractor Estimate Defaults & Templates v1 | Estimate templates, saved charges, Price Book foundation, CSV preview/import coverage, legacy estimate quick-pick behavior, PR #361 Price Book management cleanup, PR #362 Draft-first Price Book Picker v1, and PR #365 Price Book Organization Foundation v1 are merged and documented; the organization migration was applied through its controlled Sandbox and Production rollout. | Repeat-import reconciliation and broader reusable-content maturity remain active under FB-024. The reconciliation migration is source-only pending separate approval, and guarded batch rollback remains the next slice. |
