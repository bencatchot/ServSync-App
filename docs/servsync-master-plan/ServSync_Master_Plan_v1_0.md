...
| Invoices | Working, including invoice-to-Home-History filing v1 | Payment processing and contractor-side filing remain deferred. Structured invoice type/order and estimate payment schedule foundations exist for future billing terms, but payment schedule UI and invoice generation from schedule are not live. |
