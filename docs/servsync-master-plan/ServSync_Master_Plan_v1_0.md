...
The official feature backlog has been reconciled through PR #145 / merge commit `4ef3be8` and later planning updates. `docs/servsync-master-plan/ServSync_Feature_Backlog.md` is the canonical backlog inventory for FB-001 through FB-033, including folded competition-gap recommendations, Service Agreements planning, Project Collaboration planning, and explicit guardrails separating disabled/future features from live beta capabilities.
