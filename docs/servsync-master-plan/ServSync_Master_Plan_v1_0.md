...
FB-026 now includes a contractor-to-contractor referral foundation package as a distinct future trust/growth path. The foundation is SQL/RLS/RPC only for `contractor_refers_contractor` referral invite leads submitted by contractor owner/admin/office users and reviewed by platform admins. It is intentionally separate from homeowner contractor invite leads, contractor-to-homeowner invites, reward referral codes, contractor team invites, connection requests, service requests, email delivery, rewards, billing, paywalls, contractor permissions, and automatic contractor profile creation. Contractor-facing referral UI, platform-admin tracking UI, email outreach, public landing pages, rewards, and any signup attribution beyond nullable admin match fields remain future slices requiring separate approval.
