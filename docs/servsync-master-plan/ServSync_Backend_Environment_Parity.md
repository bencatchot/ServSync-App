...
Stripe Connect Online Payments Foundation v1 is a second exact Sandbox experiment group. Its 178 entries cover only the three private payment relations, 15 fixed-signature functions and grants, 53 columns, 42 constraints, 12 indexes, two cross-scope guard triggers, and owner table grants identified by the reviewed migration. The key fingerprint is `sha256:d675e9797fc6b24002e8055547463d5b4a0bcddfcd60a73eefeae2e38be5dba7` and the logical catalog fingerprint is `sha256:065241d26a208eaa6bbb559c64bb78e082489ce3fa77be556be2f073ebe76ada`. It does not approve changes to Production-supported Invoice, offline-ledger, Customer, tenant, ACL, or policy objects. Provider-backed behavior remains fail-closed without approved Stripe test configuration.
