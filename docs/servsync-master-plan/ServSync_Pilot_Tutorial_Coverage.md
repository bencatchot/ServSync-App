...
| TUT-005 | How to connect and request service | Homeowner | Connect with a contractor, choose the home, and submit a request with useful work details. | `homeowner.service` | `homeowner-connect-service-request` | **Primary active outcome; source preparation in progress, not published.** The protected scenario starts with no connection, uses the real contextual connection and contractor-acceptance path, then submits the exact home-scoped Request and verifies its stored work details remain available to the contractor. Cedar credentials, media recording, Help approval, and Production publication remain separately gated |
