...
| TUT-003 | How to complete work and save the service record | Contractor Owner, Admin, Office, Field Technician | Move an accepted Estimate into a Job, record the visit, complete the work, and finalize the report. | `contractor.work` | `contractor-complete-work` | **Validated silent source promoted.** PR #531 merged at `e4c79fcd41d038d9cb360c5b600f9e40ffa768a0`; protected Demo run `192c59a8-a3ac-42ee-b21c-d7474570bdac` promoted a 59.28-second 1440×900 H.264 package after the complete accepted Estimate -> Job -> five completed work items -> completed visit/Job -> finalized report -> Home History path passed exact lineage, browser-error, and sensitive-data gates. The next gate is a Production Help recording request plus one bounded Cedar narration/caption package, followed by normal-speed owner review. Nothing is approved or published |
