...
| TUT-004 | How to deliver an invoice and record an outside payment | Contractor Owner, Admin, Office | Create/deliver the Invoice, explain that payment collection is outside ServSync, and record a payment received elsewhere. | `contractor.financials` | `contractor-invoice-outside-payment` | **Validated silent source promoted; not narrated or published.** The exact durable Demo `ab542a5c08bebfb226d5d5fc5934372a16d2695d` run promoted a 57.96-second 1440×900 package with MP4 SHA-256 `f4fb4950f46a92b1622ad9dc9f312db163f1699f106a5dc4ea886b231d2df6d7`. It preserves exact Customer/Home/Request/Estimate/Job/Invoice/offline-payment lineage, Invoice delivery/homeowner view, **Partially Paid**, `$400.00` paid, and `$1,765.00` due. Provider/action, secret, browser, `5xx`, media, full `1x` sound-off, contextual desktop/mobile, cleanup, and zero-residue checks passed. Remaining gates: separately authorize one Cedar narration/captions/transcript package and full sound-on review; then explicit Help approval/publication and post-publication contextual/audience verification |
