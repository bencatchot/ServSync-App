...
| TUT-003 | How to complete work and save the service record | Contractor Owner, Admin, Office, Field Technician | Move an accepted Estimate into a Job, record the visit, complete the work, and finalize the report. | `contractor.work` | `contractor-complete-work` | **Duration-floor correction in progress.** PR #529 merged the persistent final-scene proof at `512c1df2410fd89a27372f0b3b972efc7c086ae1`. Protected run `c5717aaf-beac-4940-acea-6371a62647aa` passed the full workflow, final-scene, browser, sensitive-data, and exact `home_history_updated` gates, but its complete 62.36-second WebM was rejected by the estimated 65-second minimum. The bounded follow-up admits 60-115 seconds while retaining every substantive proof; no artifact, Cedar generation, approval, or publication has occurred |
