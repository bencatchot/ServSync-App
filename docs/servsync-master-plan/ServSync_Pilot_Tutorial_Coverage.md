...
Production currently contains five published video tutorials: TUT-001 **How to handle a homeowner service request**, revision 1; TUT-002 **How to create an estimate**, revision 4; TUT-003 **How to complete work and save the service record**, revision 1; TUT-004 **How to deliver an invoice and record an outside payment**, revision 1; and TUT-005 **How to connect and request service**, revision 1. TUT-002 now meets the narration/caption/transcript standard and demonstrates the current Draft-first workflow. The table below records all five published tutorials and the one missing protected workflow. A missing tutorial is not represented as available in the product until an approved revision is published.
...
| TUT-002 | How to create an estimate | Contractor Owner, Admin, Office | Plan customer work in a Draft, fill the starter line, then create an unsent Estimate. | `contractor.drafts` | `contractor-create-estimate` | **Published and verified in Production, revision 4.** Owner-approved 62.44-second Draft-first video, one Cedar generation, 14 compact captions, matching transcript/disclosure, and a 4.29-second final hold. Full hosted playback and Owner `contractor.drafts` retrieval verified exact media/caption hashes. Prior revisions and other tutorials are unchanged; audience is Owner/Admin/Office. See [evidence](../qa/TUT_002_DEMO_RECORDER_SUPPORT_2026-09-25.md). |
...
| TUT-004 | How to deliver an invoice and record an outside payment | Contractor Owner, Admin, Office | Create/deliver the Invoice, explain that payment collection is outside ServSync, and record a payment received elsewhere. | `contractor.financials` | `contractor-invoice-outside-payment` | **Published and verified in Production, revision 1.** Request `29766df4-5080-4b9a-9025-c871bed06e17` published the exact 57.96-second 1440×900 scene-synced MP4 SHA-256 `fda7f742f0838b360e200400c6190ec030a5e357bce7c531b692d5efbefb2b2c` from durable Demo `ab542a5c08bebfb226d5d5fc5934372a16d2695d`, with top-safe English captions, matching transcript, exact Cedar disclosure, and truthful Customer/Home/Request/Estimate/Job/Invoice/offline-payment lineage ending **Partially Paid**, `$400.00` paid, and `$1,765.00` due. Full Production playback reached 57.96/57.96 at `1x`; Owner-authenticated `contractor.financials` retrieval returned exactly revision 1, homeowner retrieval was denied, and the immutable audience is exactly Owner/Admin/Office with Field Technician, Viewer, and Homeowner excluded. One published entry and one originating Approved request exist with no duplicate; browser diagnostics, `5xx`, and payment/provider traffic were zero |
| TUT-005 | How to connect and request service | Homeowner | Connect with a contractor, choose the home, and submit a request with useful work details. | `homeowner.service` | `homeowner-connect-service-request` | **Published and verified in Production, revision 1.** Request `b417c413-9cd5-4950-883d-b903483134de` published the exact 119.2-second 1440×900 scene-synced MP4 SHA-256 `41d6f6cdd3f0e563475e884a4d486f245e6504d1ea62e48373c0a2fafdc3e160` from validated silent source `6a2cfcbdebe3a1e64883b6b23e7b9f99043f6277e1350f72875c6fba4c01dc2c`. One successful Cedar request produced the immutable audio; its temporary restricted key was revoked to **Inactive**. Sixteen synchronized 10-14-word top-safe English cues, matching transcript, exact disclosure, five workflow steps, and truthful final **Waiting on contractor** state passed full `1x` sound-on and muted review. Published preview loaded the HTTPS video and showing caption track with empty browser diagnostics. Immutable audience is exactly Homeowner and excludes Owner/Admin/Office/Field Technician/Viewer; route context is `homeowner.service` and purpose is Support |
...
TUT-002's Draft-first replacement and standards upgrade are complete as revision 4; it remains protected by Tutorial Freshness checks. This order gives the pilot team the contractor's front-office intake path first, then fills the rest of the end-to-end lifecycle without discarding the existing Estimate lesson before its replacement is ready.
