...
| TUT-005 | How to connect and request service | Homeowner | Connect with a contractor, choose the home, and submit a request with useful work details. | `homeowner.service` | `homeowner-connect-service-request` | **Primary active outcome; source and two corrections merged, third silent run materially failed, not published.** PR #553 merged at `646e3229f306131b38b324c66d05c27ee802ec8d`. The authorized run passed protected preflight and reached the real contextual connection dialog, but the new post-entry exact-value assertion timed out re-resolving the controlled **Optional message** field after human-paced typing. Connection submission never occurred; no retry or artifact occurred, and guarded reset plus direct audit left zero disposable residue. Stabilize exact post-entry readback after that controlled state update, regression-test, merge, and deploy before requesting another one-run authorization; Cedar credentials, Help approval, and Production publication remain separately gated |
