...
| TUT-003 | How to complete work and save the service record | Contractor Owner, Admin, Office, Field Technician | Move an accepted Estimate into a Job, record the visit, complete the work, and finalize the report. | `contractor.work` | `contractor-complete-work` | **Final-scene proof correction in progress.** PR #528 merged the live-locator activation at `719c02d550bef8ef5178831fef8d285f759dfbfc`. Protected run `2336a05e-b89f-4df4-90d8-bfeab2c7d75c` passed `home_history_updated` with all five work items complete and the exact finalized-report lineage, then rejected the artifact because a final aggregate text check re-required transient finalization feedback. The bounded follow-up proves that feedback when it appears and keeps the held scene check persistent; no artifact, Cedar generation, approval, or publication has occurred |
