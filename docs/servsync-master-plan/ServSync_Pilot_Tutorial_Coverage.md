...
| TUT-003 | How to complete work and save the service record | Contractor Owner, Admin, Office, Field Technician | Move an accepted Estimate into a Job, record the visit, complete the work, and finalize the report. | `contractor.work` | `contractor-complete-work` | **Corrected narrated package prepared; not attached.** Production request `708a66db-0c34-461f-a512-3ba0dccbc0b2` is bound to 58.84-second protected Demo source `e5ff54c9032d5f272368d2d6da2087e190790d68`. One Cedar request produced the five approved lines and its temporary key is revoked. The initial continuous mix failed synchronization review and was withheld. A provider-free derivative now anchors the same narration and WebVTT to the accepted Estimate, Job work, Complete Job, Finalize Report, and filed Home History scenes, ending at 52.937 seconds with a 5.903-second final hold. Local codec, checksum, pause, transcript, sampled-frame, screen-label, and sensitive-data checks pass. PR #533 contains the reusable fail-closed safeguard; merge it, then separately authorize exact package attachment and conduct normal-speed owner review. Nothing is approved or published |
