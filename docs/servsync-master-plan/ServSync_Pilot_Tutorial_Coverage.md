...
| TUT-003 | How to complete work and save the service record | Contractor Owner, Admin, Office, Field Technician | Move an accepted Estimate into a Job, record the visit, complete the work, and finalize the report. | `contractor.work` | `contractor-complete-work` | **Runtime blocker correction in progress.** PR #524 merged at `7328548e36881d74e02192b37e45332a12db33f4`, and durable Demo reached Ready. The first post-merge protected run created and completed the exact Job/visit, then failed closed because the five Estimate-derived billable work items remained `open` despite all five **Approved Scope** findings being **Fixed On Site**. A bounded follow-up synchronizes only exact `unbilled` Estimate-derived items and excludes drafted/invoiced, unrelated, and simple-task rows. No artifact, Cedar generation, approval, or publication has occurred |
