...
| TUT-004 | How to deliver an invoice and record an outside payment | Contractor Owner, Admin, Office | Create/deliver the Invoice, explain that payment collection is outside ServSync, and record a payment received elsewhere. | `contractor.financials` | `contractor-invoice-outside-payment` | **Production request `29766df4-5080-4b9a-9025-c871bed06e17` is Approved; not published.** The exact durable Demo `ab542a5c08bebfb226d5d5fc5934372a16d2695d` source preserves Customer/Home/Request/Estimate/Job/Invoice/offline-payment lineage, Invoice delivery/homeowner view, **Partially Paid**, `$400.00` paid, and `$1,765.00` due. Production Help Studio accepted the exact 57.96-second 1440×900 scene-synced MP4 SHA-256 `fda7f742f0838b360e200400c6190ec030a5e357bce7c531b692d5efbefb2b2c`, poster, top-safe English WebVTT, matching transcript, exact Cedar disclosure, and request-bound metadata. Exact re-verification passed before the owner-authorized narration/caption approval; one active TUT-004 request exists and **Publish for Help** is now available. Remaining gates: separate publication, then post-publication contextual/audience verification |
