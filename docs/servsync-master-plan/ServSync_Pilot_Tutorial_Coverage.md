...
| TUT-003 | How to complete work and save the service record | Contractor Owner, Admin, Office, Field Technician | Move an accepted Estimate into a Job, record the visit, complete the work, and finalize the report. | `contractor.work` | `contractor-complete-work` | **Ready for owner review.** Production request `708a66db-0c34-461f-a512-3ba0dccbc0b2` holds the corrected 58.84-second package from exact protected Demo source `e5ff54c9032d5f272368d2d6da2087e190790d68`. One Cedar request produced the approved five-line narration; its temporary key is revoked, and the failed continuous mix remains withheld. PR #533 merged the provider-free scene-alignment safeguard at `3618e177f59eca20d50ccb011c07ce3868e5eb9b`. The attached MP4, poster, English WebVTT, and metadata anchor the same immutable narration to the accepted Estimate, Job work, Complete Job, Finalize Report, and filed Home History scenes. Secure Production playback reports 58.84 seconds at 1440×900 with the English track, matching transcript, and Cedar disclosure bound. Next: full owner 1x/sound-off review and **Approve narration + captions** or **Return for rerecord**. Nothing is approved or published |
