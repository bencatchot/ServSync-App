...
| TUT-003 | How to complete work and save the service record | Contractor Owner, Admin, Office, Field Technician | Move an accepted Estimate into a Job, record the visit, complete the work, and finalize the report. | `contractor.work` | `contractor-complete-work` | **Recorder stability correction in progress.** PR #526 merged the autosave correction at `fce2c7ea1413421fb851d0aead117cc402e793f2`, and exact durable Demo deployment passed. Protected run `6e31ee0d-1347-4d76-8ee1-ffcc49d94945` still skipped the second checkbox while iterating a live locator through re-renders. An exact-label follow-up persisted and synchronized that item, proving the app correction works. The recorder now snapshots stable work titles and verifies every checked state before Save; no artifact, Cedar generation, approval, or publication has occurred |
