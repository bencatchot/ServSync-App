...
| TUT-003 | How to complete work and save the service record | Contractor Owner, Admin, Office, Field Technician | Move an accepted Estimate into a Job, record the visit, complete the work, and finalize the report. | `contractor.work` | `contractor-complete-work` | **Fresh protected Demo source validated; Production replacement pending.** PR #534 merged at `9dfff32a940e9a3b1b396253cf3a38eb8dd92c2f`, the exact durable Demo deployment passed, and the protected workflow promoted a 57.32-second 1440×900 silent source with MP4 SHA-256 `635e8dbed48e70746d5bbc2d87874b16db8f2d5c211ac96dc9af28057dab0ee6`. Full-timeline and focused Work Notes review confirm one guidance layer, no recorder callouts, preserved accepted scope throughout the interaction, an appended labeled completion note, and the final **Filed to Documents** state. Production request `708a66db-0c34-461f-a512-3ba0dccbc0b2` still holds the rejected prior package and must not be approved or published. Next: separately authorize returning that request, creating its replacement, provider-free aligning the already generated Cedar audio to this source with compact top-safe captions, and attaching the exact package for fresh owner 1x/sound-off review. Nothing new is approved or published |
