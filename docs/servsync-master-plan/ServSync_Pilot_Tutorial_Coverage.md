...
| TUT-005 | How to connect and request service | Homeowner | Connect with a contractor, choose the home, and submit a request with useful work details. | `homeowner.service` | `homeowner-connect-service-request` | **Validated silent source retained; narration/package work next; not published.** PR #566 merged the 125-second scenario contract as current main `d1a6d9039b406e7d8ca1393e483c2b3a6107e5d4`, and its durable Demo deployment passed. One fresh owner-authorized run produced a 119.2-second 1440×900 silent MP4/WebM package from that exact source. It passed the real contextual connection, contractor acceptance, home-scoped Request, exact adoption, contractor title/description/home readback, browser, sensitive-data, codec, hash, duration, and durable-promotion gates. Complete QuickTime playback reached 119.2/119.2 at normal speed and ended on the submitted Request in **Waiting on contractor**. Read-only postflight verified `request_ready`, nine registered records, one active succeeded run, zero unresolved runs, and zero issues. MP4 SHA-256 is `6a2cfcbdebe3a1e64883b6b23e7b9f99043f6277e1350f72875c6fba4c01dc2c`; WebM SHA-256 is `efc8b9616ddf64f6ba9d8e18beef3dd6e31867507e1b944cb57dc8d31b07d6bc`. The silent master remains private source evidence. Cedar generation, captions/transcript/disclosure, Production Help request/attachment, owner review, approval, and publication remain separately gated |
