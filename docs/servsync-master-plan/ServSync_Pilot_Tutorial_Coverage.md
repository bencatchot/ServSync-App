...
| TUT-003 | How to complete work and save the service record | Contractor Owner, Admin, Office, Field Technician | Move an accepted Estimate into a Job, record the visit, complete the work, and finalize the report. | `contractor.work` | `contractor-complete-work` | **Source implementation in progress** on the post-PR #523 branch: the protected scenario starts at `estimate_accepted`, uses the real **Create Job**, work-note, **Complete Job**, and **Finalize Report** path, and fail-closes around exact Job/work-item/visit/report lineage. No recording request, Cedar generation, approval, or publication has occurred |
