...
| TUT-003 | How to complete work and save the service record | Contractor Owner, Admin, Office, Field Technician | Move an accepted Estimate into a Job, record the visit, complete the work, and finalize the report. | `contractor.work` | `contractor-complete-work` | **Duration sanity-bound correction in progress.** PR #530 merged the 60-second floor at `0d920af2cbc18f81d88f62947747b0cf9cdc26b7`. Protected run `0d6d17a8-8746-4de2-92c7-06fde3e4d6e2` again passed the full workflow, final-scene, browser, sensitive-data, and exact `home_history_updated` gates, but its complete 59.12-second WebM was rejected by 0.88 seconds. The prior complete run was 62.36 seconds. The bounded follow-up uses 50-115 seconds as a media-sanity range while retaining every substantive proof; no artifact, Cedar generation, approval, or publication has occurred |
