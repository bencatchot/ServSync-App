...
| TUT-003 | How to complete work and save the service record | Contractor Owner, Admin, Office, Field Technician | Move an accepted Estimate into a Job, record the visit, complete the work, and finalize the report. | `contractor.work` | `contractor-complete-work` | **Autosave reliability correction in progress.** PR #525 merged the Estimate-derived work-item sync at `e9123800ca6b3018e7d48f35b0ad1a09557262b6`. The protected rerun proved four item updates, then failed closed because an overlapping autosave was skipped but incorrectly marked persisted, leaving one finding **Monitor** and one durable item `open`. Exact run `cb53b40d-95fb-4bfe-8b11-f4585b1281cc` remains at `job_scheduled`. A bounded follow-up retries skipped overlapping autosaves; no artifact, Cedar generation, approval, or publication has occurred |
