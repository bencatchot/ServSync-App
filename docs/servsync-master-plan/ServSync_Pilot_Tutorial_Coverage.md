...
| TUT-003 | How to complete work and save the service record | Contractor Owner, Admin, Office, Field Technician | Move an accepted Estimate into a Job, record the visit, complete the work, and finalize the report. | `contractor.work` | `contractor-complete-work` | **Recorder activation correction in progress.** PR #527 merged stable-title targeting at `4de13e96f054f6b1700f87b5c9dc262169752e38`. Protected run `ae5d8b1e-e971-46ee-8ee5-c17a2850fa9d` proved its guard by stopping when the second raw coordinate click missed after an intervening UI update. The bounded follow-up retains human cursor motion but activates the re-resolved live locator; no artifact, Cedar generation, approval, or publication has occurred |
