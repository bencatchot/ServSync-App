...
| Next recommended assignment | Review FB-039E1 Core-Authoring Durable Idempotency, then implement FB-039E2 report/Home History/document finalization reliability as the remaining protected Phase 0.4 backend slice. |
...
| Roadmap return point | Keep FB-039E active through FB-039E1 review and FB-039E2 completion; advance to Phase 0.5 only after full Phase 0.4 exact-head acceptance. |
