...
| FB-026 | Review + Referral Flow | Discover, contractor profiles, completed jobs, trust | Started / Partial | High | Existing ServSync review capture is hardened around completed-work eligibility, private party visibility, external-review separation, review table/function grant posture, and pending moderation SQL/RPC foundation. Public ServSync review averages, counts, kudos, and snippets are paused during beta until moderation/public-display policy is approved. Future work includes admin moderation UI/public-rating policy, recommendation/referral product decisions, and optional Google review handoff. No fake ratings, paid ranking, or premature badges. |
