...
Current next step:
Validate the estimate start-choice, Save as template modal, Advanced Trade Tools cleanup, and clarified Jobs/Templates taxonomy with connected homeowners, contractor-private local customers, and inline-created local customers in preview/beta. Keep true direct-job/invoice Work Template starts, Home Setup Templates/Home Map, broader recipe-library expansion, homeowner pre-visit checklist work, pricing suggestions, recipe catalog UX, and trade-coverage expansion separately approved.
