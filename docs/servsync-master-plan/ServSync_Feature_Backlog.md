...
7b. Slice 2C-C1: add explicit gated launch commitment, save-before-launch, verified attempt recovery, canonical consumed adoption, list synchronization, and explicit Open Output without automatic navigation.
