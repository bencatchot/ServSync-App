...
7c. Slice 2C-C2: open, draft, unmerged PR #321 adds canonical-consumed-first automatic Estimate/Job opening only for same-session explicit Create/Retry, while preserving explicit-only background recovery and explicit Open fallback.
