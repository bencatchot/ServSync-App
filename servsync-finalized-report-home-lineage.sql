-- ServSync finalized report property lineage correction.
--
-- Preserves the current field-work finalization contract while carrying the
-- source Job's canonical home into the generated document and Home History row.
-- Existing historical rows are intentionally not backfilled by this migration.
